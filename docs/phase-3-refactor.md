...
- [ ] Add typed API layers for player/tribe, dino, structure, equipment,
      stackable, base, JSON export, and local cluster parsing.
...
- [ ] Expand `cmd/arksave` commands beyond `inspect`/`parse`.
