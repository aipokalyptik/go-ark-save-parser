...
| P2-API-008 | `[~]` | Finish richer local cluster item/dino domain models. | Uploaded item type has typed constants/accessors, enum filters, version/parse helpers, crafter helpers, item aggregate summaries, and embedded dino component class summaries; add deeper item/dino fields only when chosen local-file fixtures expose them. |
