...
| P3-FIX-001 | `[~]` | Replace duplicated synthetic fixture builders with internal helpers. | `internal/testfixtures` centralizes many shared fixtures, including player pawn and inventory save-object builders; lower-level dino, structure, equipment, stackable, and malformed parser fixtures remain. |
