...
| P3-CLI-001 | `[x]` | Implement offline CLI commands. | `inspect`, `parse`, `structure-health`, `structure-owner-count`, `players`, `tribes`, `cluster`, `tribute`, JSON export commands, and experimental mutate commands exist. |
