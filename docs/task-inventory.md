...
| P4-VERIFY-007 | `[x]` | Public GitHub Actions verification runs on push and pull request. | `.github/workflows/verify.yml` runs `make verify` on `main` pushes and pull requests without private oracle data. |
