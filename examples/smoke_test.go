...
func TestExamplesRunAgainstLocalSyntheticFixtures(t *testing.T) {
	...
	runExample(t, "cluster_typed", "cluster=EOS_abc123 items=0 dinos=0 equipment=0 dino_items=0 other_items=0 crafted=0 unsupported_items=0 parsed_dinos=0 unsupported_dinos=0 dino_parse_errors=0 unparsed_dinos=0 dino_ids=0 tamed_dinos=0 female_dinos=0 baby_dinos=0 dead_dinos=0 dinos_with_stats=0 embedded_objects=0 parse_errors=0", clusterPath)
